    ...
    <form id="lbm_login_form" method="post">
        <section>
		    ...
		    id="lbm_lf_id_country"
                    ...
                    value="{$sl_country}"/>
            {/if}
                <input type="hidden" id="back" name="back" value="index"/>

			<div class="form-group">
				<label for="lbm_lf_mobile_number">
                ...
                <div>
                  <div class="input-group js-parent-focus">
                    <input
                      ...
                      name="password"
                      type="password"
                      value=""                       pattern=".{literal}{{/literal}5,{literal}}{/literal}"
                       required >
                    <span class="input-group-btn">
                      <button
                        class="btn"
                        type="button"
						id="lbm_lf_password_btn"
