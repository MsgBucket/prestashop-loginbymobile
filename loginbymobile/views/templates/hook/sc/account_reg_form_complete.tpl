...
<section id="lbm_ca_section" class="login-form">
	...
	<section>
		...
		<div class="form-group row">
			<label for="lbm_ca_mobile_number" class="col-md-12 form-control-label">
				{l s='Mobile Number' mod='loginbymobile'}
			</label>
			<br>
			<div class="col-md-12 lbm_mobile_div">
				<div class="input-group js-parent-focus">
					<span id="lbm_ca_form_call_prefix" style="display:table-cell;vertical-align:middle;    background: #7a7a7a;color:white;padding:0px 2px;">{$call_prefix}</span>
					<input
					...
					<span class="input-group-btn"  style="display:table-cell;vertical-align:middle;">
					  <button
						class="btn"
						type="button"
						id="send_otp_ca_form"
		...
		<div class="form-group row">
			<label for="lbm_ca_otp" class="col-md-12 form-control-label">
