...
$(document).off('click', '#lbm_lf_password_btn').on('click', '#lbm_lf_password_btn',function() {
...
function signinByMobileNumberLF()
{
	...
	$(document).off('click', '#submit-login-form-mobile').on('click', '#submit-login-form-mobile', function(e) {		
	e.preventDefault();
	e.stopPropagation();
    //if (tfotpcount === 1) {
    //    tfotpcount++;
