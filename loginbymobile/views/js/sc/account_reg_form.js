...
$(document).ready(function() {
	...
	//$("#customer-form").find("input[name='lbm_ca_mobile_number']").replaceWith(account_reg_form_mobile);
	//$("#customer-form").find("input[id != 'lbm_ca_otp'][name='lbm_ca_otp']").parent().parent().remove();
	$(account_reg_form_mobile).insertBefore($('#customer_person_information_table'));
	...
	$("#lbm_ca_mobile_number").attr( "maxlength", mobilenum_length[$("#lbm_ca_id_country").val()]);

	$("#lbm_ca_form_call_prefix").text("+"+selected_country_callprefix);

	if (LOGINBYMOBILE_MOBILE_REG == "1") {
		if (LOGINBYMOBILE_OTP_list[$("#lbm_ca_id_country").val()]) {
...
function submitResendSmsFunction_regform() {
	...
	var lbm_ca_id_country = $("#lbm_ca_id_country").val();
...
"password"===t.attr("type")?(t.attr("type","text"),(0,a.default)(this).text((0,a.default)(this).data("textHide"))):(t.attr("type","password"),(0,a.default)(this).text((0,a.default)(this).data("textShow")))})}}]),t}();e.default=s,t.exports=e.default},function(t,e,n) {"use strict";function i(t,e) {if (!(t instanceof e))throw
*/
